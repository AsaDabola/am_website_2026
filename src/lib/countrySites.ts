...
export const COUNTRY_SITES: CountrySite[] = [
  ...
  { country: "Belgium", continent: "europe", slug: "belgium", locale: "fr", countryCodes: ["BE"], nativeLanguages: ["nl", "fr", "de"], tier: "m40" },
  { country: "Czechia", continent: "europe", slug: "czechia", locale: "en", countryCodes: ["CZ"], nativeLanguages: ["cs"], tier: "m40" },
  { country: "Slovakia", continent: "europe", slug: "slovakia", locale: "en", countryCodes: ["SK"], nativeLanguages: ["sk"], tier: "m40" },
  { country: "Greece", continent: "europe", slug: "greece", locale: "en", countryCodes: ["GR"], nativeLanguages: ["el"], tier: "m40" },
  { country: "Hungary", continent: "europe", slug: "hungary", locale: "en", countryCodes: ["HU"], nativeLanguages: ["hu"], tier: "m40" },
  { country: "Netherlands", city: "Amsterdam", continent: "europe", slug: "netherlands", locale: "en", countryCodes: ["NL"], nativeLanguages: ["nl"], tier: "m40" },
  { country: "Poland", city: "Warsaw", continent: "europe", slug: "poland", locale: "en", countryCodes: ["PL"], nativeLanguages: ["pl"], tier: "m40" },
  { country: "Portugal", continent: "europe", slug: "portugal", locale: "pt", countryCodes: ["PT"], nativeLanguages: ["pt"], tier: "m40" },
  { country: "Romania", continent: "europe", slug: "romania", locale: "en", countryCodes: ["RO"], nativeLanguages: ["ro"], tier: "m40" },
  { country: "Sweden", continent: "europe", slug: "sweden", locale: "en", countryCodes: ["SE"], nativeLanguages: ["sv"], tier: "m40" },
  { country: "Switzerland", continent: "europe", slug: "switzerland", locale: "de", countryCodes: ["CH"], nativeLanguages: ["de", "fr", "it", "rm"], tier: "m40" },
  { country: "Ukraine", continent: "europe", slug: "ukraine", locale: "en", countryCodes: ["UA"], nativeLanguages: ["uk"], tier: "m40" },
