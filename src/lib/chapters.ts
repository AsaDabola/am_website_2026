...
export const CHAPTERS: Chapter[] = [
  ...
  { city: "São Paulo", country: "Brazil", region: "southamerica", lat: -23.5505, lng: -46.6333, role: "regional" },
  ...
  { city: "Paris", country: "France", region: "europe", lat: 48.8566, lng: 2.3522, role: "regional" },
  ...
  { city: "Kinshasa", country: "DR Congo", region: "africa", lat: -4.4419, lng: 15.2663, role: "regional" },
  ...
  // Asia
  { city: "Seoul", country: "South Korea", region: "asia", lat: 37.5665, lng: 126.978, role: "regional" },
  ...
  // Oceania
  { city: "Sydney", country: "Australia", region: "oceania", lat: -33.8688, lng: 151.2093, role: "regional" },
];
  ...
  for (const chapter of chapters) {
    ...
    const parent =
      global && chapter.region === global.region
        ? global
        : chapters.find((c) => c.role === "regional" && c.region === chapter.region);
